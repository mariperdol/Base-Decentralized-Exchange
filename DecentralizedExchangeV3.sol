...
contract DecentralizedExchangeV2 is Ownable, ReentrancyGuard {
    ...
    function swap(
        ...
        // Update stats
        totalVolume = totalVolume.add(amountOut);
    ...
    function getLiquidityPosition(address user, address token0) external view returns (LiquidityPosition memory) {
    ...
    function updatePoolConfig(
        ...
        require(maxPriceImpact <= 1000, "Price impact too high");
